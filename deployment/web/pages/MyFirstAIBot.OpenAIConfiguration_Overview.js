...
const { $Container, $Div, $Text, $Fragment, $TabContainer, $ConditionalVisibilityWrapper, $ActionButton, $Datagrid, $ListView, $PopupMenu, $Image, $DatagridTextFilter } = asPluginWidgets({ Container, Div, Text, Fragment, TabContainer, ConditionalVisibilityWrapper, ActionButton, Datagrid, ListView, PopupMenu, Image, DatagridTextFilter });

const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Container key="p.MyFirstAIBot.OpenAIConfiguration_Overview.container1"
        $widgetId="p.MyFirstAIBot.OpenAIConfiguration_Overview.container1"
        class={"mx-name-container1"}
        style={undefined}
        renderMode={"div"}
        onClick={undefined}
        content={[
            <$Div key="p.MyFirstAIBot.OpenAIConfiguration_Overview.layoutGrid1"
                $widgetId="p.MyFirstAIBot.OpenAIConfiguration_Overview.layoutGrid1"
                class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
                style={undefined}
                content={[
                    <$Div key="p.MyFirstAIBot.OpenAIConfiguration_Overview.layoutGrid1$row0"
                        $widgetId="p.MyFirstAIBot.OpenAIConfiguration_Overview.layoutGrid1$row0"
                        class={"row"}
                        style={undefined}
                        content={[
                            <$Div key="p.MyFirstAIBot.OpenAIConfiguration_Overview.layoutGrid1$row0$column0"
                                $widgetId="p.MyFirstAIBot.OpenAIConfiguration_Overview.layoutGrid1$row0$column0"
                                class={"col-lg col-md col"}
                                style={undefined}
                                content={[
                                    <$Text key="p.MyFirstAIBot.OpenAIConfiguration_Overview.text1"
                                        $widgetId="p.MyFirstAIBot.OpenAIConfiguration_Overview.text1"
                                        class={"mx-name-text1"}
                                        style={undefined}
                                        caption={t([
                                            ExpressionProperty({
                                                "expression": { "expr": { "type": "literal", "value": "OpenAI Configuration" }, "args": {} }
                                            })
                                        ])}
                                        renderMode={"h2"} />,
                                    <$Fragment key="p.MyFirstAIBot.OpenAIConfiguration_Overview.snippetCall1"
                                        $widgetId="p.MyFirstAIBot.OpenAIConfiguration_Overview.snippetCall1"
                                        content={[
                                                        ...
                                                        "content": [
                                                            ...
                                                            <$Datagrid key="p.OpenAIConnector.Snippet_Configurations.dataGrid21"
                                                                ...
                                                                datasource={DatabaseObjectListProperty({
                                                                    ...
                                                                    "operationId": "F8f91qHd7V2rEiHkuVuR0Q",
                                                                    "sort": [],
                                                                            ...
                                                                            "children": () => [
                                                                                <$ListView key="p.OpenAIConnector.Snippet_Configurations.listView1"
                                                                                    ...
                                                                                    listValue={DatabaseObjectListProperty({
                                                                                        ...
                                                                                        "operationId": "/pJSZq8hkVy9DkW+ZuAg8Q",
                                                                                        "sort": [
                                                                                            [
                                                                                                "OutputModality",
                                                                                                "desc"
                                                        ...
                                                        "content": [
                                                            ...
                                                            <$Datagrid key="p.OpenAIConnector.Snippet_Configurations.dataGrid2_1"
                                                                ...
                                                                datasource={DatabaseObjectListProperty({
                                                                    ...
                                                                    "operationId": "rj1kKZ9uj1qvPTKknhP9Sw",
                                                                    "sort": []
                                                                })}
                                                                refreshInterval={0}
                                                                itemSelectionMethod={"checkbox"}
                                                                            ...
                                                                            "children": () => [
                                                                                <$ListView key="p.OpenAIConnector.Snippet_Configurations.listView2"
                                                                                    ...
                                                                                    listValue={DatabaseObjectListProperty({
                                                                                        ...
                                                                                        "operationId": "4q0WUPnCM1KH7b2s7EFvfg",
                                                                                        "sort": [],
                                                                                        "arguments": {
                                                                                            "currentObject": [
