...
import { content as parentContent } from "../layouts/ConversationalUI.Layout_Sidebar.js";
...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid1"
        ...
        style={undefined}
        content={[
            <$Div key="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid1$row0"
                $widgetId="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid1$row0$column0"
                        $widgetId="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid1$row0$column0"
                        class={"col-lg-12 col-md-12 col-12"}
                        style={undefined}
                        content={[
                            <$ActionButton key="p.ConversationalUI.ConversationalUI_Sidebar.MinimizeChat"
                            ...
                            <$DataView key="p.ConversationalUI.ConversationalUI_Sidebar.dataView1"
                                ...
                                body={[
                                    <$Container key="p.ConversationalUI.ConversationalUI_Sidebar.container3"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$Fragment key="p.ConversationalUI.ConversationalUI_Sidebar.snippetCall1"
                                                                                                                                                    ...
                                                                                                                                                    groups={[
                                                                                                                                                        {
                                                                                                                                                            ...
                                                                                                                                                            "headerContent": [
                                                                                                                                                                <$Div key="p.ConversationalUI.Snippet_Message_Sources.layoutGrid2"
                                                                                                                                                                    ...
                                                                                                                                                                    style={undefined}
                                                                                                                                                                    content={[
                                                                                                                                                                        <$Div key="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid2$row0"
                                                                                                                                                                            $widgetId="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid2$row0"
                                                                                                                                                                            class={"row align-children-center"}
                                                                                                                                                                            style={undefined}
                                                                                                                                                                            content={[
                                                                                                                                                                                <$Div key="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid2$row0$column0"
                                                                                                                                                                                ...
                                                                                                                                                                                <$Div key="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid2$row0$column1"
                                                                                                                        ...
                                                                                                                        <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_Message_StatusHandling.layoutGrid2$visibility"
                                                                                                                            ...
                                                                                                                            contents={[
                                                                                                                                <$Div key="p.ConversationalUI.Snippet_Message_StatusHandling.layoutGrid2"
                                                                                                                                    ...
                                                                                                                                    style={undefined}
                                                                                                                                    content={[
                                                                                                                                        <$Div key="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid2$row0.83"
                                                                                                                                            $widgetId="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid2$row0.83"
                                                                                                                                            class={"row align-children-center"}
                                                                                                                                            style={undefined}
                                                                                                                                            content={[
                                                                                                                                                <$Div key="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid2$row0$column0.84"
                                                                                                                                                ...
                                                                                                                                                <$Div key="p.ConversationalUI.ConversationalUI_Sidebar.layoutGrid2$row0$column1.87"
...
export const classes = "layout-chat-sidebar";

export const cancelChangesOperationId = "8Z2fMYxFMlWmdZAirnUkLg";
export const closeButton = "p.ConversationalUI.ConversationalUI_Sidebar.MinimizeChat";
export const style = {};
