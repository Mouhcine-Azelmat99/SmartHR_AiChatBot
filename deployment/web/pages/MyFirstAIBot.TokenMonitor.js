...
import * as LineChartWidgetModule from "C:/Users/MouhcineAZELMAT/Desktop/Mendix Projects/SmartHRAssistance/deployment/web/widgets/com/mendix/widget/web/linechart/LineChart.mjs";
...
import "C:/Users/MouhcineAZELMAT/Desktop/Mendix Projects/SmartHRAssistance/deployment/web/widgets/com/mendix/widget/web/linechart/LineChart.css";
import { Text } from "mendix/widgets/web/Text";
import { addEnumerations, asPluginWidgets, t } from "mendix";

import { content as parentContent } from "../layouts/Atlas_Core.Atlas_TopBar.js";

const { $DataView, $Div, $Container, $Text, $Fragment, $FormGroup, $Combobox, $ConditionalVisibilityWrapper, $Image, $ActionButton, $DatePicker, $LineChart } = asPluginWidgets({ DataView, Div, Container, Text, Fragment, FormGroup, Combobox, ConditionalVisibilityWrapper, Image, ActionButton, DatePicker, LineChart });
...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$DataView key="p.MyFirstAIBot.TokenMonitor.dataView1"
        $widgetId="p.MyFirstAIBot.TokenMonitor.dataView1"
        ...
        body={[
            <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid4"
                $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid4"
                class={"mx-name-layoutGrid4 mx-layoutgrid mx-layoutgrid-fluid container-fluid layoutgrid--full-height"}
                style={undefined}
                content={[
                    <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid4$row0"
                        $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid4$row0"
                        class={"row"}
                        style={undefined}
                        content={[
                            <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid4$row0$column0"
                                $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid4$row0$column0"
                                class={"col-lg col-md col"}
                                style={undefined}
                                content={[
                                    <$Container key="p.MyFirstAIBot.TokenMonitor.container1"
                                        $widgetId="p.MyFirstAIBot.TokenMonitor.container1"
                                        class={"mx-name-container1 card card-border card--sticky-content spacing-outer-bottom-none"}
                                        style={undefined}
                                        renderMode={"div"}
                                        onClick={undefined}
                                        content={[
                                            <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid2"
                                                $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid2"
                                                class={"mx-name-layoutGrid2 mx-layoutgrid mx-layoutgrid-fluid spacing-outer-top-large"}
                                                style={undefined}
                                                content={[
                                                    <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid2$row0"
                                                        $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid2$row0"
                                                        class={"row"}
                                                        style={undefined}
                                                        content={[
                                                            <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid2$row0$column0"
                                                                $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid2$row0$column0"
                                                                class={"col-lg col-md col"}
                                                                style={undefined}
                                                                content={[
                                                                    <$Container key="p.MyFirstAIBot.TokenMonitor.container2"
                                                                        $widgetId="p.MyFirstAIBot.TokenMonitor.container2"
                                                                        class={"mx-name-container2 pageheader row-left spacing-outer-bottom-large"}
                                                                        style={undefined}
                                                                        renderMode={"div"}
                                                                        onClick={undefined}
                                                                        content={[
                                                                            <$Text key="p.MyFirstAIBot.TokenMonitor.text40"
                                                                                $widgetId="p.MyFirstAIBot.TokenMonitor.text40"
                                                                                class={"mx-name-text40 pageheader-title spacing-outer-bottom spacing-outer-right-medium"}
                                                                                style={undefined}
                                                                                caption={t([
                                                                                    ExpressionProperty({
                                                                                        "expression": { "expr": { "type": "literal", "value": "Token monitor" }, "args": {} }
                                                                                    })
                                                                                ])}
                                                                                renderMode={"h1"} />,
                                                                            <$Fragment key="p.MyFirstAIBot.TokenMonitor.snippetCall2"
                                                                                $widgetId="p.MyFirstAIBot.TokenMonitor.snippetCall2"
                                                                                content={[
                                                                                    <$FormGroup key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.comboBox1$formGroup"
                                                                                        ...
                                                                                        style={undefined}
                                                                                        control={[
                                                                                            <$Combobox key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.comboBox1"
                                                                                                ...
                                                                                                optionsSourceAssociationDataSource={AssociationObjectListProperty({
                                                                                                    ...
                                                                                                    "scope": "$TokenMonitorSettings",
                                                                                                    "operationId": "jvOxlgDad1+V7MpDhKDA5g",
                                                                                                ...
                                                                                                optionsSourceAssociationCustomContent={TemplatedWidgetProperty({
                                                                                                    ...
                                                                                                    "editable": false,
                                                                                                    "children": () => [
                                                                                                        <$Container key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.container11"
                                                                                                            ...
                                                                                                            onClick={undefined}
                                                                                                            content={[
                                                                                                                <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.image1$visibility"
                                                                                                                    ...
                                                                                                                    contents={[
                                                                                                                        <$Image key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.image1"
                                                                                                                ...
                                                                                                                <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.image2$visibility"
                                                                                                                    ...
                                                                                                                    contents={[
                                                                                                                        <$Image key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.image2"
                                                                                                                ...
                                                                                                                <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.image3$visibility"
                                                                                                                    ...
                                                                                                                    contents={[
                                                                                                                        <$Image key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.image3"
                                                                                                                ...
                                                                                                                <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.image4$visibility"
                                                                                                                    ...
                                                                                                                    contents={[
                                                                                                                        <$Image key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.image4"
                                                                                                                ...
                                                                                                                <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.image5$visibility"
                                                                                                                    ...
                                                                                                                    contents={[
                                                                                                                        <$Image key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.image5"
                                                                                                                ...
                                                                                                                <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DeploymentSelection.text1"
                                                                        ...
                                                                        ariaHidden={false} />,
                                                                    <$Fragment key="p.MyFirstAIBot.TokenMonitor.snippetCall3"
                                                                        $widgetId="p.MyFirstAIBot.TokenMonitor.snippetCall3"
                                                                        content={[
                                                                            <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_CurrentMonthUsage.text24"
                                                                                ...
                                                                                renderMode={"h4"} />,
                                                                            <$Container key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_CurrentMonthUsage.container3"
                                                                                ...
                                                                                onClick={undefined}
                                                                                content={[
                                                                                    <$Div key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_CurrentMonthUsage.layoutGrid3"
                                                                                        ...
                                                                                        style={undefined}
                                                                                        content={[
                                                                                            <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid3$row0"
                                                                                                $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid3$row0"
                                                                                                class={"row"}
                                                                                                style={undefined}
                                                                                                content={[
                                                                                                    <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid3$row0$column0"
                                                                                                        $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid3$row0$column0"
                                                                                                        class={"col-lg col-md col"}
                                                                                                        style={undefined}
                                                                                                        content={[
                                                                                                            <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_CurrentMonthUsage.text25"
                                                                                                                ...
                                                                                                                renderMode={"h5"} />,
                                                                                                            <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_CurrentMonthUsage.text22"
                                                                                                    ...
                                                                                                    <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid3$row0$column1"
                                                                                                        $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid3$row0$column1"
                                                                                                        class={"col-lg col-md col"}
                                                                                                        style={undefined}
                                                                                                        content={[
                                                                                                            <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_CurrentMonthUsage.text26"
                                                                                                                ...
                                                                                                                renderMode={"h5"} />,
                                                                                                            <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_CurrentMonthUsage.text23$visibility"
                                                                                                                ...
                                                                                                                contents={[
                                                                                                                    <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_CurrentMonthUsage.text23"
                                                                                                            ...
                                                                                                            <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_CurrentMonthUsage.text30$visibility"
                                                                                                                ...
                                                                                                                contents={[
                                                                                                                    <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_CurrentMonthUsage.text30"
                                                            ...
                                                            <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid2$row0$column1"
                                                                $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid2$row0$column1"
                                                                class={"col-lg-auto col-md-auto col-auto"}
                                                                style={undefined}
                                                                content={[
                                                                    <$Container key="p.MyFirstAIBot.TokenMonitor.container12"
                                                                        $widgetId="p.MyFirstAIBot.TokenMonitor.container12"
                                                                        class={"mx-name-container12 row-right"}
                                                                        style={undefined}
                                                                        renderMode={"div"}
                                                                        onClick={undefined}
                                                                        content={[
                                                                            <$ConditionalVisibilityWrapper key="p.MyFirstAIBot.TokenMonitor.actionButton1$visibility"
                                                                                $widgetId="p.MyFirstAIBot.TokenMonitor.actionButton1$visibility"
                                                                                visible={ExpressionProperty({
                                                                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                                                })}
                                                                                contents={[
                                                                                    <$ActionButton key="p.MyFirstAIBot.TokenMonitor.actionButton1"
                                                                                        $widgetId="p.MyFirstAIBot.TokenMonitor.actionButton1"
                                                                                        buttonId={"p.MyFirstAIBot.TokenMonitor.actionButton1"}
                                                                                        ...
                                                                                        action={ActionProperty({
                                                                                            "action": { "type": "openPage", "argMap": {}, "config": { "name": "MyFirstAIBot/TokenMonitor_Export.page.xml", "location": "content", "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": true },
                                                    ...
                                                    <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid2$row1"
                                                        $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid2$row1"
                                                        class={"row"}
                                                        style={undefined}
                                                        content={[
                                                            <$Div key="p.MyFirstAIBot.TokenMonitor.layoutGrid2$row1$column0"
                                                                $widgetId="p.MyFirstAIBot.TokenMonitor.layoutGrid2$row1$column0"
                                                                class={"col-lg col-md col"}
                                                                style={undefined}
                                                                content={[
                                                                    <$Fragment key="p.MyFirstAIBot.TokenMonitor.snippetCall1"
                                                                        $widgetId="p.MyFirstAIBot.TokenMonitor.snippetCall1"
                                                                        content={[
                                                                            <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.text27"
                                                                                ...
                                                                                renderMode={"h4"} />,
                                                                            <$Container key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container6"
                                                                                ...
                                                                                onClick={undefined}
                                                                                content={[
                                                                                    <$Container key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container8"
                                                                                        ...
                                                                                        onClick={undefined}
                                                                                        content={[
                                                                                            <$Container key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container5"
                                                                                                ...
                                                                                                onClick={undefined}
                                                                                                content={[
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton2$visibility"
                                                                                                        ...
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton2"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton10$visibility"
                                                                                                        ...
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton10"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton3$visibility"
                                                                                                        ...
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton3"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton11$visibility"
                                                                                                        ...
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton11"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton5$visibility"
                                                                                                        $widgetId="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton5$visibility"
                                                                                                        visible={ExpressionProperty({
                                                                                                            "expression": { "expr": { "type": "conditional", "condition": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "then": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Day" } ] }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Week" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "MonthToDate" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "_3Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "_6Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Custom" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "All" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": null } ] } }, "else": { "type": "literal", "value": false } }, "args": { "TokenMonitorSettings": { "widget": "$TokenMonitorSettings", "source": "object" } } }
                                                                                                        })}
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton5"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton12$visibility"
                                                                                                        ...
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton12"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton4$visibility"
                                                                                                        $widgetId="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton4$visibility"
                                                                                                        visible={ExpressionProperty({
                                                                                                            "expression": { "expr": { "type": "conditional", "condition": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "then": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Day" } ] }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Week" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "_3Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "_6Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Custom" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "All" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": null } ] } }, "else": { "type": "literal", "value": false } }, "args": { "TokenMonitorSettings": { "widget": "$TokenMonitorSettings", "source": "object" } } }
                                                                                                        })}
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton4"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton13$visibility"
                                                                                                        ...
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton13"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton6$visibility"
                                                                                                        $widgetId="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton6$visibility"
                                                                                                        visible={ExpressionProperty({
                                                                                                            "expression": { "expr": { "type": "conditional", "condition": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "then": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Day" } ] }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Week" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "MonthToDate" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "_6Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Custom" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "All" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": null } ] } }, "else": { "type": "literal", "value": false } }, "args": { "TokenMonitorSettings": { "widget": "$TokenMonitorSettings", "source": "object" } } }
                                                                                                        })}
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton6"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton14$visibility"
                                                                                                        ...
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton14"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton7$visibility"
                                                                                                        $widgetId="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton7$visibility"
                                                                                                        visible={ExpressionProperty({
                                                                                                            "expression": { "expr": { "type": "conditional", "condition": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "then": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Day" } ] }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Week" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "MonthToDate" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "_3Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Custom" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "All" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": null } ] } }, "else": { "type": "literal", "value": false } }, "args": { "TokenMonitorSettings": { "widget": "$TokenMonitorSettings", "source": "object" } } }
                                                                                                        })}
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton7"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton15$visibility"
                                                                                                        ...
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton15"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton16$visibility"
                                                                                                        $widgetId="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton16$visibility"
                                                                                                        visible={ExpressionProperty({
                                                                                                            "expression": { "expr": { "type": "conditional", "condition": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "then": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Day" } ] }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Week" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "MonthToDate" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "_3Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "_6Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Custom" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": null } ] } }, "else": { "type": "literal", "value": false } }, "args": { "TokenMonitorSettings": { "widget": "$TokenMonitorSettings", "source": "object" } } }
                                                                                                        })}
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton16"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton8$visibility"
                                                                                                        $widgetId="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton8$visibility"
                                                                                                        visible={ExpressionProperty({
                                                                                                            "expression": { "expr": { "type": "conditional", "condition": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "then": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "All" } ] }, "else": { "type": "literal", "value": false } }, "args": { "TokenMonitorSettings": { "widget": "$TokenMonitorSettings", "source": "object" } } }
                                                                                                        })}
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton8"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton9$visibility"
                                                                                                        $widgetId="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton9$visibility"
                                                                                                        visible={ExpressionProperty({
                                                                                                            "expression": { "expr": { "type": "conditional", "condition": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "then": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "conditional", "condition": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Day" } ] }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Week" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "MonthToDate" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "_3Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "_6Month" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": "All" } ] } }, "then": { "type": "literal", "value": true }, "else": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "TokenMonitorSettings", "path": "TimeRange" }, { "type": "literal", "value": null } ] } }, "else": { "type": "literal", "value": false } }, "args": { "TokenMonitorSettings": { "widget": "$TokenMonitorSettings", "source": "object" } } }
                                                                                                        })}
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton9"
                                                                                                    ...
                                                                                                    <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton17$visibility"
                                                                                                        ...
                                                                                                        contents={[
                                                                                                            <$ActionButton key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.actionButton17"
                                                                                                ...
                                                                                                ariaHidden={false} />,
                                                                                            <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container9$visibility"
                                                                                                ...
                                                                                                contents={[
                                                                                                    <$Container key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container9"
                                                                                                        ...
                                                                                                        onClick={undefined}
                                                                                                        content={[
                                                                                                            <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.text2"
                                                                                            ...
                                                                                            <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container4$visibility"
                                                                                                ...
                                                                                                contents={[
                                                                                                    <$Container key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container4"
                                                                                                        ...
                                                                                                        onClick={undefined}
                                                                                                        content={[
                                                                                                            <$FormGroup key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.datePicker1$formGroup"
                                                                                                                ...
                                                                                                                style={undefined}
                                                                                                                control={[
                                                                                                                    <$DatePicker key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.datePicker1"
                                                                                                            ...
                                                                                                            <$FormGroup key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.datePicker3$formGroup"
                                                                                                                ...
                                                                                                                style={undefined}
                                                                                                                control={[
                                                                                                                    <$DatePicker key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.datePicker3"
                                                                                                            ...
                                                                                                            <$FormGroup key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.datePicker2$formGroup"
                                                                                                                ...
                                                                                                                style={undefined}
                                                                                                                control={[
                                                                                                                    <$DatePicker key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.datePicker2"
                                                                                                            ...
                                                                                                            <$FormGroup key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.datePicker4$formGroup"
                                                                                                                ...
                                                                                                                style={undefined}
                                                                                                                control={[
                                                                                                                    <$DatePicker key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.datePicker4"
                                                                                        ...
                                                                                        ariaHidden={false} />,
                                                                                    <$Container key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container7"
                                                                                        ...
                                                                                        onClick={undefined}
                                                                                        content={[
                                                                                            <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.text28"
                                                                                                ...
                                                                                                renderMode={"h4"} />,
                                                                                            <$LineChart key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.lineChart1"
                                                                                                ...
                                                                                                lines={[
                                                                                                    {
                                                                                                        ...
                                                                                                        "staticDataSource": MicroflowObjectListProperty({
                                                                                                            ...
                                                                                                            "scope": "$TokenMonitorSettings",
                                                                                                            "operationId": "p7iRTrajmlmQDyuMmxTT2A"
                                                                                                        }),
                                                                                                        "staticName": t([
                                                                                                            ExpressionProperty({
                                                                                                ...
                                                                                                style={undefined}
                                                                                                tabIndex={undefined} />,
                                                                                            <$ConditionalVisibilityWrapper key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container10$visibility"
                                                                                                $widgetId="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container10$visibility"
                                                                                                visible={ExpressionProperty({
                                                                                                    "expression": { "expr": { "type": "variable", "variable": "TokenMonitorSettings", "path": "ShowOutput" }, "args": { "TokenMonitorSettings": { "widget": "$TokenMonitorSettings", "source": "object" } } }
                                                                                                })}
                                                                                                contents={[
                                                                                                    <$Container key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.container10"
                                                                                                        ...
                                                                                                        onClick={undefined}
                                                                                                        content={[
                                                                                                            <$Text key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.text29"
                                                                                                                ...
                                                                                                                renderMode={"h4"} />,
                                                                                                            <$LineChart key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_DetailedUsage.lineChart2"
                                                                                                                ...
                                                                                                                lines={[
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        "staticDataSource": MicroflowObjectListProperty({
                                                                                                                            ...
                                                                                                                            "entity": "ConversationalUI.UsageBin",
                                                                                                                            "scope": "$TokenMonitorSettings",
                                                                                                                            "operationId": "6DfNUbsFDViVXmF6CDeJew"
                                                                                                                        }),
                                                                                                                        "staticName": t([
                                                                                                                            ExpressionProperty({
