...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p.AmazonBedrockConnector.Settings_NewEdit.layoutGrid1"
        $widgetId="p.AmazonBedrockConnector.Settings_NewEdit.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p.AmazonBedrockConnector.Settings_NewEdit.layoutGrid1$row0"
                $widgetId="p.AmazonBedrockConnector.Settings_NewEdit.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p.AmazonBedrockConnector.Settings_NewEdit.layoutGrid1$row0$column0"
                        $widgetId="p.AmazonBedrockConnector.Settings_NewEdit.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p.AmazonBedrockConnector.Settings_NewEdit.dataView6"
                                ...
                                body={[
                                    <$FormGroup key="p.AmazonBedrockConnector.Settings_NewEdit.comboBox1$formGroup"
                                        $widgetId="p.AmazonBedrockConnector.Settings_NewEdit.comboBox1$formGroup"
                                        class={"mx-name-comboBox1"}
                                        style={undefined}
                                        control={[
                                            <$Combobox key="p.AmazonBedrockConnector.Settings_NewEdit.comboBox1"
                                    ...
                                    <$FormGroup key="p.AmazonBedrockConnector.Settings_NewEdit.radioButtons1$formGroup"
                                        ...
                                        style={undefined}
                                        control={[
                                            <$RadioButtonGroup key="p.AmazonBedrockConnector.Settings_NewEdit.radioButtons1"
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ConditionalVisibilityWrapper key="p.AmazonBedrockConnector.Settings_NewEdit.actionButton1$visibility"
                                        $widgetId="p.AmazonBedrockConnector.Settings_NewEdit.actionButton1$visibility"
                                        visible={ExpressionProperty({
                                            "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                        })}
                                        contents={[
                                            <$ActionButton key="p.AmazonBedrockConnector.Settings_NewEdit.actionButton1"
                                                ...
                                                action={ActionProperty({
                                                    "action": { "type": "callMicroflow", "argMap": { "Settings": { "widget": "$Settings", "source": "object" } }, "config": { "operationId": "zxBMFSr2kl+XeIqbuxOloA", "progress": { "message": t([ "" ]), "modal": true }, "validate": "view", "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": true },
                                                    "abortOnServerValidation": true
                                                })} />
                                        ]} />,
                                    <$ConditionalVisibilityWrapper key="p.AmazonBedrockConnector.Settings_NewEdit.actionButton2$visibility"
                                        $widgetId="p.AmazonBedrockConnector.Settings_NewEdit.actionButton2$visibility"
                                        visible={ExpressionProperty({
                                            "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                        })}
                                        contents={[
                                            <$ActionButton key="p.AmazonBedrockConnector.Settings_NewEdit.actionButton2"
...
export const cancelChangesOperationId = "CtbjDB5QAV20wj311ICBJg";
export const style = {};
