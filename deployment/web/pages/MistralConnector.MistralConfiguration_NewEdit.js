...
import { ACT_MistralConfiguration_SetEndpoint_DefaultMistral } from "../nanoflows/MistralConnector.ACT_MistralConfiguration_SetEndpoint_DefaultMistral.js";
...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p.MistralConnector.MistralConfiguration_NewEdit.layoutGrid1"
        $widgetId="p.MistralConnector.MistralConfiguration_NewEdit.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p.MistralConnector.MistralConfiguration_NewEdit.layoutGrid1$row0"
                $widgetId="p.MistralConnector.MistralConfiguration_NewEdit.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p.MistralConnector.MistralConfiguration_NewEdit.layoutGrid1$row0$column0"
                        $widgetId="p.MistralConnector.MistralConfiguration_NewEdit.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p.MistralConnector.MistralConfiguration_NewEdit.dataView1"
                                ...
                                body={[
                                    <$FormGroup key="p.MistralConnector.MistralConfiguration_NewEdit.textBox4$formGroup"
                                        $widgetId="p.MistralConnector.MistralConfiguration_NewEdit.textBox4$formGroup"
                                        class={"mx-name-textBox4 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p.MistralConnector.MistralConfiguration_NewEdit.textBox4"
                                    ...
                                    <$FormGroup key="p.MistralConnector.MistralConfiguration_NewEdit.textArea1$formGroup"
                                        ...
                                        style={undefined}
                                        control={[
                                            <$TextArea key="p.MistralConnector.MistralConfiguration_NewEdit.textArea1"
                                    ...
                                    <$Container key="p.MistralConnector.MistralConfiguration_NewEdit.container2"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$Container key="p.MistralConnector.MistralConfiguration_NewEdit.container1"
                                                ...
                                                onClick={undefined}
                                                content={[
                                                    <$Text key="p.MistralConnector.MistralConfiguration_NewEdit.text2"
                                                        ...
                                                        renderMode={"span"} />,
                                                    <$ConditionalVisibilityWrapper key="p.MistralConnector.MistralConfiguration_NewEdit.actionButton3$visibility"
                                                        $widgetId="p.MistralConnector.MistralConfiguration_NewEdit.actionButton3$visibility"
                                                        visible={ExpressionProperty({
                                                            "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                        })}
                                                        contents={[
                                                            <$ActionButton key="p.MistralConnector.MistralConfiguration_NewEdit.actionButton3"
                                        ...
                                        ariaHidden={false} />,
                                    <$DataView key="p.MistralConnector.MistralConfiguration_NewEdit.dataView2"
                                        ...
                                        body={[
                                            <$FormGroup key="p.MistralConnector.MistralConfiguration_NewEdit.textBox5$formGroup"
                                                ...
                                                style={undefined}
                                                control={[
                                                    <$TextBox key="p.MistralConnector.MistralConfiguration_NewEdit.textBox5"
                                            ...
                                            <$ConditionalVisibilityWrapper key="p.MistralConnector.MistralConfiguration_NewEdit.container3$visibility"
                                                ...
                                                contents={[
                                                    <$Container key="p.MistralConnector.MistralConfiguration_NewEdit.container3"
                                                        ...
                                                        onClick={undefined}
                                                        content={[
                                                            <$Text key="p.MistralConnector.MistralConfiguration_NewEdit.text3"
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ConditionalVisibilityWrapper key="p.MistralConnector.MistralConfiguration_NewEdit.actionButton1$visibility"
                                        $widgetId="p.MistralConnector.MistralConfiguration_NewEdit.actionButton1$visibility"
                                        visible={ExpressionProperty({
                                            "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                        })}
                                        contents={[
                                            <$ActionButton key="p.MistralConnector.MistralConfiguration_NewEdit.actionButton1"
                                    ...
                                    <$ActionButton key="p.MistralConnector.MistralConfiguration_NewEdit.actionButton2"
...
export const cancelChangesOperationId = "RfKdfMwlwVSeFxJoD2V9lQ";
export const style = {};
