...
public class UserActionsRegistrar
{
  public void registerActions(IActionRegistrator registrator)
  {
    ...
    registrator.registerUserAction(amazonbedrockconnector.actions.Converse.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.CreateDataSource.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.DeleteDataSource.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.GetAgent.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.GetDataSource.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.GetIngestionJob.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.InvokeAgent.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.InvokeModel.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.JA_CohereEmbed_ModifyJson_Response.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.JA_TitanEmbeddings_ModifyJson_Response.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.ListAgents.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.ListDataSources.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.ListFoundationModels.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.ListIngestionJobs.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.ListKnowledgeBases.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.Request_AddComputerUseTool.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.Retrieve.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.RetrieveAndGenerate.class);
    registrator.registerUserAction(amazonbedrockconnector.actions.StartIngestionJob.class);
    ...
    registrator.registerUserAction(mxgenaiconnector.actions.CohereEmbedResponse_ModifyJson.class);
    registrator.registerUserAction(mxgenaiconnector.actions.KnowledgeBaseChunkList_Delete_ByMxObject.class);
    registrator.registerUserAction(mxgenaiconnector.actions.KnowledgeBaseChunkList_Delete_ByMxObjectList.class);
    registrator.registerUserAction(mxgenaiconnector.actions.KnowledgeBaseChunkList_Embed_RetrieveNearestNeighbors_SetAssociation.class);
    registrator.registerUserAction(mxgenaiconnector.actions.KnowledgeBaseChunkList_Retrieve.class);
    registrator.registerUserAction(mxgenaiconnector.actions.KnowledgeBaseChunkList_Retrieve_SetAssociation.class);
    registrator.registerUserAction(mxgenaiconnector.actions.Request_Modify_Converse.class);
    registrator.registerUserAction(mxgenaiconnector.actions.Response_ModifyForMapping_Converse.class);
