...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Container key="p.MyFirstAIBot.MistralConfiguration_Overview.container1"
        ...
        onClick={undefined}
        content={[
            <$Div key="p.MyFirstAIBot.MistralConfiguration_Overview.layoutGrid1"
                $widgetId="p.MyFirstAIBot.MistralConfiguration_Overview.layoutGrid1"
                class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
                style={undefined}
                content={[
                    <$Div key="p.MyFirstAIBot.MistralConfiguration_Overview.layoutGrid1$row0"
                        $widgetId="p.MyFirstAIBot.MistralConfiguration_Overview.layoutGrid1$row0"
                        class={"row"}
                        style={undefined}
                        content={[
                            <$Div key="p.MyFirstAIBot.MistralConfiguration_Overview.layoutGrid1$row0$column0"
                                $widgetId="p.MyFirstAIBot.MistralConfiguration_Overview.layoutGrid1$row0$column0"
                                class={"col-lg col-md col"}
                                style={undefined}
                                content={[
                                    <$Text key="p.MyFirstAIBot.MistralConfiguration_Overview.text1"
                                        ...
                                        renderMode={"h2"} />,
                                    <$Fragment key="p.MyFirstAIBot.MistralConfiguration_Overview.snippetCall1"
