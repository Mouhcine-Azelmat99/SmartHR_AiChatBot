...
public class Response implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	...
	{
		if (mendixObject.isInstanceOf("AmazonBedrockConnector.ChatCompletionsResponse")) {
			return amazonbedrockconnector.proxies.ChatCompletionsResponse.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("AmazonBedrockConnector.RetrieveAndGenerateResponse")) {
			return amazonbedrockconnector.proxies.RetrieveAndGenerateResponse.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("AmazonBedrockConnector.RetrieveResponse")) {
			return amazonbedrockconnector.proxies.RetrieveResponse.initialize(context, mendixObject);
		}
		if (mendixObject.isInstanceOf("AmazonBedrockConnector.TitanImageResponse")) {
