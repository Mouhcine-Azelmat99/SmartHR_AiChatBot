...
import * as PopupMenuWidgetModule from "C:/Users/MouhcineAZELMAT/Desktop/Mendix Projects/SmartHRAssistance/deployment/web/widgets/com/mendix/widget/web/popupmenu/PopupMenu.mjs";
...
import "C:/Users/MouhcineAZELMAT/Desktop/Mendix Projects/SmartHRAssistance/deployment/web/widgets/com/mendix/widget/web/popupmenu/PopupMenu.css";
...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Fragment key="p.AgentCommons.Agent_Overview.snippetCall1"
        $widgetId="p.AgentCommons.Agent_Overview.snippetCall1"
        content={[
            <$Container key="p.AgentCommons.Snippet_Agent_Overview.container1"
                ...
                onClick={undefined}
                content={[
                    <$Container key="p.AgentCommons.Snippet_Agent_Overview.container2"
                        ...
                        onClick={undefined}
                        content={[
                            <$Container key="p.AgentCommons.Snippet_Agent_Overview.container3"
                                ...
                                onClick={undefined}
                                content={[
                                    <$Container key="p.AgentCommons.Snippet_Agent_Overview.container9"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$Text key="p.AgentCommons.Snippet_Agent_Overview.text1"
                                        ...
                                        ariaHidden={false} />,
                                    <$Container key="p.AgentCommons.Snippet_Agent_Overview.container5"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.actionButton1$visibility"
                                                $widgetId="p.AgentCommons.Snippet_Agent_Overview.actionButton1$visibility"
                                                visible={ExpressionProperty({
                                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                })}
                                                contents={[
                                                    <$ActionButton key="p.AgentCommons.Snippet_Agent_Overview.actionButton1"
                                            ...
                                            <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.actionButton2$visibility"
                                                $widgetId="p.AgentCommons.Snippet_Agent_Overview.actionButton2$visibility"
                                                visible={ExpressionProperty({
                                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                })}
                                                contents={[
                                                    <$ActionButton key="p.AgentCommons.Snippet_Agent_Overview.actionButton2"
                                ...
                                ariaHidden={false} />,
                            <$Datagrid key="p.AgentCommons.Snippet_Agent_Overview.dataGrid21"
                                ...
                                columns={[
                                    {
                                        ...
                                        "content": TemplatedWidgetProperty({
                                            ...
                                            "editable": false,
                                            "children": () => [
                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container26"
                                                    ...
                                                    onClick={undefined}
                                                    content={[
                                                        <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.tooltip2$visibility"
                                                            ...
                                                            contents={[
                                                                <$Tooltip key="p.AgentCommons.Snippet_Agent_Overview.tooltip2"
                                                                    $widgetId="p.AgentCommons.Snippet_Agent_Overview.tooltip2"
                                                                    trigger={[
                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text10"
                                                                    ...
                                                                    renderMethod={"custom"}
                                                                    htmlMessage={[
                                                                        <$Container key="p.AgentCommons.Snippet_Agent_Overview.container31"
                                                                            ...
                                                                            onClick={undefined}
                                                                            content={[
                                                                                <$Text key="p.AgentCommons.Snippet_Agent_Overview.text7"
                                                    ...
                                                    ariaHidden={false} />,
                                                <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.text11$visibility"
                                                    $widgetId="p.AgentCommons.Snippet_Agent_Overview.text11$visibility"
                                                    visible={ExpressionProperty({
                                                        "expression": { "expr": { "type": "function", "name": "=", "parameters": [ { "type": "function", "name": "trim", "parameters": [ { "type": "variable", "variable": "currentObject", "path": "Description" } ] }, { "type": "literal", "value": "" } ] }, "args": { "currentObject": { "widget": "p.AgentCommons.Snippet_Agent_Overview.dataGrid21", "source": "object" } } }
                                                    })}
                                                    contents={[
                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text11"
                                    ...
                                    },
                                    {
                                        ...
                                        "content": TemplatedWidgetProperty({
                                            ...
                                            "editable": false,
                                            "children": () => [
                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container4"
                                                    ...
                                                    onClick={undefined}
                                                    content={[
                                                        <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.tooltip1$visibility"
                                                            ...
                                                            contents={[
                                                                <$Tooltip key="p.AgentCommons.Snippet_Agent_Overview.tooltip1"
                                                                    $widgetId="p.AgentCommons.Snippet_Agent_Overview.tooltip1"
                                                                    trigger={[
                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text3"
                                                                    ...
                                                                    renderMethod={"custom"}
                                                                    htmlMessage={[
                                                                        <$Div key="p.AgentCommons.Snippet_Agent_Overview.layoutGrid1"
                                                                            ...
                                                                            content={[
                                                                                <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row0"
                                                                                    $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row0"
                                                                                    class={"row no-gutters"}
                                                                                    style={undefined}
                                                                                    content={[
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row0$column0"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row0$column0"
                                                                                            class={"col-lg-4 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container27"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text32"
                                                                                        ...
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row0$column1"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row0$column1"
                                                                                            class={"col-lg-8 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container6"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text20"
                                                                                ...
                                                                                <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row1"
                                                                                    $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row1"
                                                                                    class={"row no-gutters"}
                                                                                    style={undefined}
                                                                                    content={[
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row1$column0"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row1$column0"
                                                                                            class={"col-lg-4 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container12"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text43"
                                                                                        ...
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row1$column1"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row1$column1"
                                                                                            class={"col-lg-8 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container13"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text17"
                                                                                ...
                                                                                <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row2"
                                                                                    $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row2"
                                                                                    class={"row no-gutters"}
                                                                                    style={undefined}
                                                                                    content={[
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row2$column0"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row2$column0"
                                                                                            class={"col-lg-4 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container14"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text44"
                                                                                        ...
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row2$column1"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row2$column1"
                                                                                            class={"col-lg-8 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container15"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text15"
                                                                                ...
                                                                                <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row3"
                                                                                    $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row3"
                                                                                    class={"row no-gutters"}
                                                                                    style={undefined}
                                                                                    content={[
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row3$column0"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row3$column0"
                                                                                            class={"col-lg-4 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container16"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text45"
                                                                                        ...
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid1$row3$column1"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid1$row3$column1"
                                                                                            class={"col-lg-8 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container17"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text27"
                                                        ...
                                                        <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.text5$visibility"
                                                            $widgetId="p.AgentCommons.Snippet_Agent_Overview.text5$visibility"
                                                            visible={ExpressionProperty({
                                                                "expression": { "expr": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "currentObject", "path": "AgentCommons.Agent_Version_InUse" }, { "type": "literal", "value": null } ] }, "args": { "currentObject": { "widget": "p.AgentCommons.Snippet_Agent_Overview.dataGrid21", "source": "object" } } }
                                                            })}
                                                            contents={[
                                                                <$Text key="p.AgentCommons.Snippet_Agent_Overview.text5"
                                    ...
                                    },
                                    {
                                        ...
                                        "content": TemplatedWidgetProperty({
                                            ...
                                            "editable": false,
                                            "children": () => [
                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container18"
                                                    ...
                                                    onClick={undefined}
                                                    content={[
                                                        <$DataView key="p.AgentCommons.Snippet_Agent_Overview.dataView1"
                                                            ...
                                                            body={[
                                                                <$Tooltip key="p.AgentCommons.Snippet_Agent_Overview.tooltip3"
                                                                    $widgetId="p.AgentCommons.Snippet_Agent_Overview.tooltip3"
                                                                    trigger={[
                                                                        <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.text24$visibility"
                                                                            ...
                                                                            contents={[
                                                                                <$Text key="p.AgentCommons.Snippet_Agent_Overview.text24"
                                                                    ...
                                                                    renderMethod={"custom"}
                                                                    htmlMessage={[
                                                                        <$Div key="p.AgentCommons.Snippet_Agent_Overview.layoutGrid2"
                                                                            ...
                                                                            content={[
                                                                                <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row0"
                                                                                    $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row0"
                                                                                    class={"row no-gutters"}
                                                                                    style={undefined}
                                                                                    content={[
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row0$column0"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row0$column0"
                                                                                            class={"col-lg-4 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container28"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text33"
                                                                                        ...
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row0$column1"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row0$column1"
                                                                                            class={"col-lg-8 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container19"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text22"
                                                                                ...
                                                                                <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row1"
                                                                                    $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row1"
                                                                                    class={"row no-gutters"}
                                                                                    style={undefined}
                                                                                    content={[
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row1$column0"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row1$column0"
                                                                                            class={"col-lg-4 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container20"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text46"
                                                                                        ...
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row1$column1"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row1$column1"
                                                                                            class={"col-lg-8 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container21"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text26"
                                                                                ...
                                                                                <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row2"
                                                                                    $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row2"
                                                                                    class={"row no-gutters"}
                                                                                    style={undefined}
                                                                                    content={[
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row2$column0"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row2$column0"
                                                                                            class={"col-lg-4 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container22"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text47"
                                                                                        ...
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row2$column1"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row2$column1"
                                                                                            class={"col-lg-8 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container23"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text29"
                                                                                ...
                                                                                <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row3"
                                                                                    $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row3"
                                                                                    class={"row no-gutters"}
                                                                                    style={undefined}
                                                                                    content={[
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row3$column0"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row3$column0"
                                                                                            class={"col-lg-4 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container24"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text48"
                                                                                        ...
                                                                                        <$Div key="p.AgentCommons.Agent_Overview.layoutGrid2$row3$column1"
                                                                                            $widgetId="p.AgentCommons.Agent_Overview.layoutGrid2$row3$column1"
                                                                                            class={"col-lg-8 col-md col"}
                                                                                            style={undefined}
                                                                                            content={[
                                                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container25"
                                                                                                    ...
                                                                                                    onClick={undefined}
                                                                                                    content={[
                                                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text28"
                                    ...
                                    },
                                    {
                                        ...
                                        "content": TemplatedWidgetProperty({
                                            ...
                                            "editable": false,
                                            "children": () => [
                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container32"
                                                    ...
                                                    onClick={undefined}
                                                    content={[
                                                        <$DataView key="p.AgentCommons.Snippet_Agent_Overview.dataView3"
                                                            ...
                                                            body={[
                                                                <$Text key="p.AgentCommons.Snippet_Agent_Overview.text6"
                                    ...
                                    },
                                    {
                                        ...
                                        "content": TemplatedWidgetProperty({
                                            ...
                                            "editable": false,
                                            "children": () => [
                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container29"
                                                    ...
                                                    onClick={undefined}
                                                    content={[
                                                        <$DataView key="p.AgentCommons.Snippet_Agent_Overview.dataView2"
                                                            ...
                                                            body={[
                                                                <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.text2$visibility"
                                                                    ...
                                                                    contents={[
                                                                        <$Text key="p.AgentCommons.Snippet_Agent_Overview.text2"
                                    ...
                                    },
                                    {
                                        ...
                                        "content": TemplatedWidgetProperty({
                                            ...
                                            "editable": false,
                                            "children": () => [
                                                <$PopupMenu key="p.AgentCommons.Snippet_Agent_Overview.pop_upMenu1"
                                                    $widgetId="p.AgentCommons.Snippet_Agent_Overview.pop_upMenu1"
                                                    advancedMode={true}
                                                    menuTrigger={[
                                                        <$Image key="p.AgentCommons.Snippet_Agent_Overview.staticImage1"
                                                    ...
                                                    customItems={[
                                                        {
                                                            "content": [
                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container11"
                                                                    ...
                                                                    onClick={undefined}
                                                                    content={[
                                                                        <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.actionButton6$visibility"
                                                                            $widgetId="p.AgentCommons.Snippet_Agent_Overview.actionButton6$visibility"
                                                                            visible={ExpressionProperty({
                                                                                "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                                            })}
                                                                            contents={[
                                                                                <$ActionButton key="p.AgentCommons.Snippet_Agent_Overview.actionButton6"
                                                        ...
                                                        {
                                                            "content": [
                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container10"
                                                                    ...
                                                                    onClick={undefined}
                                                                    content={[
                                                                        <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.actionButton5$visibility"
                                                                            $widgetId="p.AgentCommons.Snippet_Agent_Overview.actionButton5$visibility"
                                                                            visible={ExpressionProperty({
                                                                                "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                                            })}
                                                                            contents={[
                                                                                <$ActionButton key="p.AgentCommons.Snippet_Agent_Overview.actionButton5"
                                                        ...
                                                        {
                                                            "content": [
                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container7"
                                                                    ...
                                                                    onClick={undefined}
                                                                    content={[
                                                                        <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.actionButton4$visibility"
                                                                            $widgetId="p.AgentCommons.Snippet_Agent_Overview.actionButton4$visibility"
                                                                            visible={ExpressionProperty({
                                                                                "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                                            })}
                                                                            contents={[
                                                                                <$ActionButton key="p.AgentCommons.Snippet_Agent_Overview.actionButton4"
                                                        ...
                                                        {
                                                            "content": [
                                                                <$Container key="p.AgentCommons.Snippet_Agent_Overview.container8"
                                                                    ...
                                                                    onClick={undefined}
                                                                    content={[
                                                                        <$ConditionalVisibilityWrapper key="p.AgentCommons.Snippet_Agent_Overview.actionButton3$visibility"
                                                                            $widgetId="p.AgentCommons.Snippet_Agent_Overview.actionButton3$visibility"
                                                                            visible={ExpressionProperty({
                                                                                "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" } ] }, "args": {} }
                                                                            })}
                                                                            contents={[
                                                                                <$ActionButton key="p.AgentCommons.Snippet_Agent_Overview.actionButton3"
                                                                                    ...
                                                                                    action={ActionProperty({
                                                                                        "action": { "type": "callMicroflow", "argMap": { "Agent": { "widget": "p.AgentCommons.Snippet_Agent_Overview.dataGrid21", "source": "object" } }, "config": { "operationId": "3AgV6/klo1W4QBvCeoaTBg", "validate": "view", "confirmation": { "question": t([ "Are you sure?" ]), "proceed": t([ "Proceed" ]), "cancel": t([ "Cancel" ]) }, "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": true },
                                                                                        "abortOnServerValidation": true
                                                                                    })} />
                                                                            ]} />
                                                                    ]}
                                ...
                                onClick={ListActionProperty({
                                    "action": { "type": "callMicroflow", "argMap": { "Agent": { "widget": "p.AgentCommons.Snippet_Agent_Overview.dataGrid21", "source": "object" } }, "config": { "operationId": "/HRjWwiSP1C4kwg8JKmBkA", "async": true, "progress": { "message": t([ "" ]), "modal": true }, "validate": "view", "allowedRoles": [ "Administrator" ] }, "disabledDuringExecution": false },
