...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid4"
        ...
        style={undefined}
        content={[
            <$Div key="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid4$row0"
                $widgetId="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid4$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid4$row0$column0"
                        $widgetId="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid4$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$Container key="p.MyFirstAIBot.TokenMonitor_Export.container1"
                                ...
                                onClick={undefined}
                                content={[
                                    <$Fragment key="p.MyFirstAIBot.TokenMonitor_Export.snippetCall1"
                                        ...
                                        content={[
                                            <$Div key="p.ConversationalUI.Snippet_TokenConsumptionMonitor_Export.layoutGrid2"
                                                ...
                                                style={undefined}
                                                content={[
                                                    <$Div key="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid2$row0"
                                                        $widgetId="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid2$row0"
                                                        class={"row"}
                                                        style={undefined}
                                                        content={[
                                                            <$Div key="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid2$row0$column0"
                                                            ...
                                                            <$Div key="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid2$row0$column1"
                                                    ...
                                                    <$Div key="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid2$row1"
                                                        $widgetId="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid2$row1"
                                                        class={"row"}
                                                        style={undefined}
                                                        content={[
                                                            <$Div key="p.MyFirstAIBot.TokenMonitor_Export.layoutGrid2$row1$column0"
