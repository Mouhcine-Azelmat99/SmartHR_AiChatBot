...
import { CheckBox } from '../CheckBox-ByItCQQA.js';
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $Combobox,
                                  {
                                    ...
                                    optionsSourceAssociationDataSource: DatabaseObjectListProperty({
                                      ...
                                      "scope": "p.Administration.Account_Edit.dataView1",
                                      "operationId": "ujmhvhFj5luX5ThPNJiW1A",
                                      "sort": [
                                        [
                                          "Name",
                                          "asc"
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $Combobox,
                                  {
                                    ...
                                    optionsSourceAssociationDataSource: DatabaseObjectListProperty({
                                      ...
                                      "scope": "p.Administration.Account_Edit.dataView1",
                                      "operationId": "W5ggtY0fSVKVjhWI0D5rJw",
                                      "sort": []
                                    }),
                                    optionsSourceAssociationCaptionType: "attribute",
                                    optionsSourceAssociationCaptionAttribute: ListAttributeProperty({
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $Combobox,
                                  {
                                    ...
                                    optionsSourceAssociationDataSource: DatabaseObjectListProperty({
                                      ...
                                      "scope": "p.Administration.Account_Edit.dataView1",
                                      "operationId": "dvjtGYE6GFGOfp9snC3aMg",
                                      "sort": [
                                        [
                                          "RawOffset",
                                          "asc"
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $ActionButton,
                                  {
                                    ...
                                    action: ActionProperty({
                                      "action": { "type": "callMicroflow", "argMap": { "Account": { "widget": "$Account", "source": "object" } }, "config": { "operationId": "1wL1ApZOjli8pQhfZtB+9g", "allowedRoles": ["Administrator"] }, "disabledDuringExecution": false },
                        ...
                        footer: [
                          /* @__PURE__ */ React.createElement(
                            $ActionButton,
                            {
                              ...
                              icon: void 0,
                              action: ActionProperty({
                                "action": { "type": "saveChanges", "argMap": { "$object": { "widget": "p.Administration.Account_Edit.dataView1", "source": "object" } }, "config": { "operationId": "aWfqSi3qBluI0nha0wTvJA", "closePage": true }, "disabledDuringExecution": true },
                                "abortOnServerValidation": true
                              })
                            }
                          ),
                          /* @__PURE__ */ React.createElement(
                            $ActionButton,
                            {
                              ...
                              icon: void 0,
                              action: ActionProperty({
                                "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "xPvfxyp3B1C9bmGscR9WJQ", "closePage": true }, "disabledDuringExecution": true },
                                "abortOnServerValidation": true
                              })
                            }
                          )
...
const classes = "";
const cancelChangesOperationId = "TFmkYYFz5FabhhVdD7iubw";
